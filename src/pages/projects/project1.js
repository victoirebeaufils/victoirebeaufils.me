  ...
  <Layout>
      ...
      <div className="container">
           <div className="row technologies">
               <div className=""> <h3><span className="badge  badge-dark">HTML</span></h3>
               </div>
               <div className="">  <h3><span className="badge  badge-dark">CSS</span></h3>
                </div>
                <div className=""> <h3><span className="badge  badge-dark">Javascript</span></h3>
                    </div>
